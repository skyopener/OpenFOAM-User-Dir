...
const Foam::scalar Foam::interfaceImmersedBoundaryProperties::convertToRad =
...
void Foam::interfaceImmersedBoundaryProperties::correctContactAngle
(
...
void Foam::interfaceImmersedBoundaryProperties::correctIBContactAngle
(
...
) const
{
    ...
    // Unit normal at IB wall
    surfaceVectorField nHatfIB
    (
...
*/
    ...
    // Apply IB wall contact angle
    correctIBContactAngle(nHatfv, gradAlphaf);
...
:
    ...
    immersedBoundaryPropertiesDict_(IBDict),
    cAlpha_
    (
        readScalar
        (
