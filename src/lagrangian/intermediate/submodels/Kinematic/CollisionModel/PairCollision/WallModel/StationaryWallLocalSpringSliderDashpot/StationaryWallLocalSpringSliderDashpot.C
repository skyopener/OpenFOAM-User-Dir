...
void Foam::StationaryWallLocalSpringSliderDashpot<CloudType>::findMinMaxProperties
(
    scalar& rMin,
    scalar& rhoMax,
    scalar& UMagMax
...
template<class CloudType>
void Foam::StationaryWallLocalSpringSliderDashpot<CloudType>::evaluateWall
(
...
template<class CloudType>
Foam::StationaryWallLocalSpringSliderDashpot<CloudType>::StationaryWallLocalSpringSliderDashpot
(
...
template<class CloudType>
Foam::scalar Foam::StationaryWallLocalSpringSliderDashpot<CloudType>::pREff
(
...
template<class CloudType>
bool Foam::StationaryWallLocalSpringSliderDashpot<CloudType>::controlsTimestep() const
{
    return true;
}
...
template<class CloudType>
Foam::label Foam::StationaryWallLocalSpringSliderDashpot<CloudType>::nSubCycles() const
{
    if (!(this->owner().size()))
    {
        return 1;
